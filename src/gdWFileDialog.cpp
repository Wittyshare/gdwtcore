  ...
  : gdWDialog("", refData, gdWDialog::buttonNone), m_dlgType(dlgType), m_strRootPath(rootPath), m_strCurPath(rootPath), m_refData(refData), m_tbFlags(vFlags)
{
  ...
  switch (m_dlgType) {
  case typeOpen          :
    setWindowTitle(WString::tr("gdwfiledlg-Open"));
    break;
  case typeAppend        :
    setWindowTitle(WString::tr("gdwfiledlg-Append"));
    break;
  case typeSave          :
    setWindowTitle(WString::tr("gdwfiledlg-Save"));
    break;
  case typeSaveAs        :
    setWindowTitle(WString::tr("gdwfiledlg-SaveAs"));
    break;
  case typeSaveChecked   :
    setWindowTitle(WString::tr("gdwfiledlg-SaveChecked"));
    break;
  case typeSaveAsChecked :
    setWindowTitle(WString::tr("gdwfiledlg-SaveAsChecked"));
    break;
  case typeImport        :
    setWindowTitle(WString::tr("gdwfiledlg-Import"));
    break;
  case typeLink          :
    setWindowTitle(WString::tr("gdwfiledlg-Link"));
    break;
  case typeWebLink       :
    setWindowTitle(WString::tr("gdwfiledlg-WebLink"));
    break;
  case typeWebDownload   :
    setWindowTitle(WString::tr("gdwfiledlg-WebDownload"));
    break;
  }
  switch (m_dlgType) {
  case typeOpen              :
    setWindowIcon(wApp->theme()->resourcesUrl() + "gdwtcore/Icons/folder.png");
    break;
  case typeAppend            :
    setWindowIcon(wApp->theme()->resourcesUrl() + "gdwtcore/Icons/folder.png");
    break;
