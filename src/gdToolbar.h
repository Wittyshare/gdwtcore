...
public : // Signals
  Wt::Signal<gdToolbarItem*, Wt::WMouseEvent>& clicked()       {
    return clicked_;
  }
  Wt::Signal<gdToolbarItem*, Wt::WMouseEvent>& doubleClicked() {
    return doubleClicked_;
  }
  Wt::Signal<gdToolbarItem*, Wt::WMouseEvent>& mouseWentOver() {
    return mouseWentOver_;
  }
  Wt::Signal<gdToolbarItem*, Wt::WMouseEvent>& mouseWentOut()  {
    return mouseWentOut_;
  }
